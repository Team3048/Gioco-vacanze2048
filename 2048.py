...
# "self" è una convenzione utilizzata nelle classi, non deve essere per forza chiamato self, ma deve essere sempre il primo parametro di qualsiasi funzione appartente alla classe a cui si riferisce.
class Game (tk.Frame): # Abbiamo creato una classe di gioco seguita dal nome che abbiamo dato alla classe: Game, inoltre abbiamo una cornice rettangolare che conterrà gli oggetti di gioco(celle) che andremo a disegnare.
    ...
    def make_GUI(self): # Creiamo una griglia 4x4, GUI: "Graphic User Interface" è dunque un interfaccia che viene disegnata sullo schermo con la quale l'utente può interagire.
        ...
        # Label: testo non modificabile; frame = cornice; score = punteggio
    ...
    # Aggiungere una casella 2 o 4 in modo casuale ad una cella casuale.
    ...
    def horizontal_move_exists(self): # Sopra e sotto.
        for i in range(4):
            for j in range(3):
    ...
    def vertical_move_exists(self): # Destra e sinistra.
        for i in range(3):
            for j in range(4):
